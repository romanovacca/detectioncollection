...
class Darknet(nn.Module):
    def __init__(self, cfgfile):
        ...
        self.net_info, self.module_list = create_pytorch_modules(self.blocks)
        self.handler = Handler()

    def forward(self, x, CUDA):
        modules = self.blocks

        # Cache the output feature maps since route and shortcut layers need output maps from previous layers
        # k,v = indices of the layer,feature maps
        outputs = {}
        ...
        for i, module in enumerate(modules):
            ...
            if module_type == "convolutional" or module_type == "upsample":
                ...
                if CUDA:
                    ...
                    x = x.data
                x = self.handler.predict_transform(x, inp_dim, anchors, num_classes, CUDA)
